              ...
              <?php elseif ($devolucion['ESTADO'] == 5): ?>
                <div class="reembolsopendiente">
                  ...
                  <div class="reembolso-botones">
                    <button class="aprobar-reembolso"
                      onclick="aprobarReembolso(<?php echo $devolucion['CODIGO_CARRITO']; ?>)">Aprobar</button>
                    <button class="rechazar-reembolso"
                      onclick="rechazarReembolso(<?php echo $devolucion['CODIGO_CARRITO']; ?>)">Rechazar</button>
                  </div>
                </div>
