            ...
            <div class="producto-info">
              ...
              <?php elseif ($devolucion['ESTADO'] == 5): ?>
                ...
                <div class="botones-container">
                  <button class="editar-motivo" onclick="abrirModalEditar(<?php echo $devolucion['CODIGO_CARRITO']; ?>)">Editar Motivo</button>
                  <button class="cancelar-solicitud" onclick="cancelarReembolso(<?php echo $devolucion['CODIGO_CARRITO']; ?>)">Cancelar Solicitud</button>
                  </div>
                </div>
  ...
  <div id="modalEditarReembolso" class="modal">
    <div class="modal-content">
      ...
      <form id="formEditarReembolso" method="post" action="/SuperRosita/index.php?action=editarReembolso">
        ...
        <textarea name="descripcion" id="descripcionEditar" maxlength="100"
          placeholder="Editar motivo del reembolso (máximo 100 caracteres)"></textarea>
        <div class="footer">
